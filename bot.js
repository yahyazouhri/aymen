...
client.user.setGame(`/bc |The_Blm`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/FgcVrZ 
            **`);
...
client.login(NTI1NjAxNTQzNDU4OTE0MzE0.XJ_SCg.kjKham-_zHEQL8sG5KMupJ42YG0);